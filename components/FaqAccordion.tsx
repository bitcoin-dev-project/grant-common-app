...
export default function FaqAccordion() {
  const faqs = [
    ...
    },
    {
      ...
      answer: (
        <p>
          Currently, the common application serves four major Bitcoin funding organizations: Btrust, Brink, Maelstrom, and Spiral. Each organization has its own focus areas and evaluation criteria.
        </p>
      )
    },
    {
